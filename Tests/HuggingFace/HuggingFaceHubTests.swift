...
class HuggingFaceHubTests: XCTestCase {
    ...
    var client: HuggingFace.Hub.Client { HuggingFace.Hub.Client(downloadBase: downloadDestination) }

    func testConfigDownload() async {
        do {
            let configLoader = HuggingFace.LanguageModelConfigurationFromHub(modelName: "t5-base", client: client)
